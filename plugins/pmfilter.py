...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        try:
            ...
            miniapp_link = f"https://t.me/{temp.U_NAME}?startapp=w_{str(log_msg.id)}_{get_hash(log_msg)}"
            ...
            await log_msg.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🚀 ꜰᴀꜱᴛ ᴅᴏᴡɴʟᴏᴀᴅ 🚀", url=dreamx_download),  # we download Link
                                                    InlineKeyboardButton('🖥️ ᴡᴀᴛᴄʜ ᴏɴʟɪɴᴇ 🖥️', url=dreamx_stream)], [InlineKeyboardButton('📱 OPEN IN MINI APP', url=miniapp_link)]])  # web stream Link
            )
            dreamcinezone = await query.edit_message_reply_markup(
                reply_markup=InlineKeyboardMarkup([
                    ...
                    [InlineKeyboardButton('📱 OPEN IN MINI APP', url=miniapp_link)],
                    [
